...
namespace f3
{
    public class MaterialUtil
    {
        ...
        {
            Material m = Resources.Load<Material>("StandardMaterials/defaults/default_vertex_colored");
            m.color = c;
            return m;
        }
        ...
        {
            Material m = Resources.Load<Material>("StandardMaterials/defaults/default_text_material");
            return m;
        }
